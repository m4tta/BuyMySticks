  ...
  <div class="flex pt-20 flex-col md:flex-row"> <!-- content -->
    <div class="w-full md:w-1/3 lg:w-1/5 flex flex-col bg-white-pure h-full md:fixed"> <!-- left col -->
      <div class="py-4 text-grey-dark">
          <router-link tag="div" to="/dashboard/inventory" class="link px-6 py-6 flex no-underline items-center border-r-8 hover:border-blue hover:text-black border-transparent cursor-pointer" active-class="border-blue text-black">
          ...
          <router-link tag="div" to="/dashboard/orders" class="link px-6 py-6 flex no-underline items-center border-r-8 hover:border-blue hover:text-black border-transparent cursor-pointer" active-class="border-blue text-black">
          ...
          <router-link tag="div" to="/dashboard/inbox" class="link px-6 py-6 flex no-underline items-center border-r-8 hover:border-blue hover:text-black border-transparent cursor-pointer" active-class="border-blue text-black">
          ...
          <router-link tag="div" to="/dashboard/users" class="link px-6 py-6 flex no-underline items-center border-r-8 hover:border-blue hover:text-black border-transparent cursor-pointer" active-class="border-blue text-black">
